...
/* Input parameters */
input int            PORT = 8680;                  // Connection Port to the Server
input string         ADDR = "localhost";           // IP Address to connect to
input int            num_data_to_save = 10;        // Amount of Data to save
